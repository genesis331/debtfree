  ...
  return (
      <div className="min-h-screen flex flex-col px-6 py-10 gap-6">
                      ...
                      <CardContent className="px-5 py-4">
                          <div className="flex flex-col gap-4">
                              <div className="flex flex-col gap-1">
                                  <div className="text-xs text-gray-500">Housing Loan</div>
          ...
          <div className="flex flex-col gap-3.5">
              ...
              <div className="flex flex-col gap-4">
                  ...
                  <Card className="shadow-none">
                      <CardContent className="px-5 py-4">
                          <div className="flex flex-col gap-4">
                              <div className="flex flex-col gap-1">
                                  <div className="text-xs text-gray-500">Vehicle Loan</div>
              ...
              <div className="text-center font-medium text-gray-500">View more offers</div>
          </div>
      </div>
  );
}
